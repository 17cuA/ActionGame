...
public class PlayerMover : MonoBehaviour
{
    ...
    void Start()
    {
		...
		instance = GetComponent<PlayerMover>();
    }
	...
	void Update()
	{
		...
		{
			moveX = /*Input.GetAxis("Horizontal")*/moveInput * -speed;
			#region ジャンプ処理
	...
	void LateUpdate()
	{
		//print(new Vector3(Mathf.Clamp(transform.position.x, CameraControll.instance.lBottom.x + 1.0f, CameraControll.instance.rTop.x - 1.0f), transform.position.y, 0));
		// 登場シーンが終わるまで動かせない
		if (UIManager_Game.instance.call_Once )
		{
