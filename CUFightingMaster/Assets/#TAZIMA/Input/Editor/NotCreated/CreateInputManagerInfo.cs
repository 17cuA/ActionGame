...
//-------------------------------------------------------------------------
public class CreateInputManagerInfo : AssetPostprocessor
{
	// Axisタイプ
	...
	private const string TEMPLATE = @"// This file is generated by CreateInputManagerInfo.
using UnityEngine;
using System.Collections;
...
";
	...
	//-------------------------------------------------------------------------
	// 変更されたInputManager.assetの情報からInputManagerInfo.csを作成する
	//-------------------------------------------------------------------------
