...
public class InputManagerSetter
{
	...
	public static void SetInputManager()
	{
		...
		//その他の項目を追加（無いとエラーログが出るので）
		inputManagerGenerator.AddAxis(InputAxis.CreateKeyAxis("Submit", "", "", "", ""));
		inputManagerGenerator.AddAxis(InputAxis.CreateKeyAxis("Horizontal", "", "", "", ""));
		inputManagerGenerator.AddAxis(InputAxis.CreateKeyAxis("Vertical", "", "", "", ""));
